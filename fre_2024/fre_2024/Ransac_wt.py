...
bp = [[-0.5, 0.15], [2, 0.50], [-0.5, -0.50], [2, -0.15]]
...
class LidarRansacNode(Node):
    ...
    def ransac(self, X, y, max_iters=100, samples_to_fit=2, inlier_threshold=0.35, min_inliers=5):
        best_model = None
    ...
    def scan_callback(self, msg):
        ...
        if len(lines_m) > 0 or (len(lines_m) == 0 and 0.5 < self.position_.x < 9.5):
            ...
            try:
                ...
                self.pub_mid_point_goal.publish(point_msg)
