...
class NavigatorWithOdom(Node):
    ...
    def main(self):
        ...
        goal_pose0 = self.create_pose_stamped(self.initial_pose, 1.1234, 2.92345, 0)
        goal_pose1 = self.create_pose_stamped(self.initial_pose, 2.26345, 1.55345, 0)
        goal_pose2 = self.create_pose_stamped(self.initial_pose, 1.24258, -1.309508, 0)
        goal_pose3 = self.create_pose_stamped(self.initial_pose, 1.12345, -3.08584, 0)
        goal_pose4 = self.create_pose_stamped(self.initial_pose, 6.62345, -3.02345, 0)

        # --- Follow Waypoints ---
        waypoints = [goal_pose0, goal_pose1, goal_pose2, goal_pose3]
