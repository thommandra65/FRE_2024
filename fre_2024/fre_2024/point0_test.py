...
class NavigatorWithOdom(Node):
    ...
    def main(self):
        ...
        goal_pose1 = self.create_pose_stamped(self.current_pose, 1.8, 0.0, 0.0)
        goal_pose2 = self.create_pose_stamped(goal_pose1, 0.0, 0.0, 1.80)
        goal_pose3 = self.create_pose_stamped(goal_pose2, 1.0, 0.0, 0.0)
